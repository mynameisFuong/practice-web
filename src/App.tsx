    ...
    <main className="homepage">
      ...
      <section id="quick-links" className="quick-links-section">
        ...
        <div className="quick-links">
          <a href="#" className="link-card">Danh sách thiết bị</a>
          <a href="#" className="link-card">Danh sách phòng học</a>
          <a href="#" className="link-card">Báo cáo hỏng hóc</a>
          <a href="#" className="link-card">Biểu đồ thống kê</a>
        </div>
      </section>
